...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------------------------------------------.  ,-------------------------------------------------------------------------------------------------------.
         XXXXXXX, KC_P7, RALT_T(KC_P8),        KC_P9,         XXXXXXX,      KC_MINUS, XXXXXXX,    XXXXXXX,                UNI_SLASH,         UNI_LCUR,   UNI_RCUR, RALT_T(UNI_EXLM), UNI_PERCENT, XXXXXXX,
  //|-----------+------+--------------+-------------+----------------+--------------+--------|  |---------------+------------------+-----------------+-----------+-----------------+------------+--------|
      KC_KP_PLUS, KC_P4,         KC_P5,        KC_P6, LSFT_T(XXXXXXX), TD(TD_QUOTES), XXXXXXX,    TD(TD_SLASHES),            UNI_AT, LSFT_T(UNI_LBRC),   UNI_RBRC,         UNI_QUES,    UNI_ASTR, XXXXXXX,
  //|-----------+------+--------------+-------------+----------------+--------------+--------'  `---------------+------------------+-----------------+-----------+-----------------+------------+--------|
...
const hsv_t PROGMEM matrix_colors[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----------+------------------+------------------+------------------+------------------+-------------+-----------|  |------------+-------------+----------+---------+-------------+-------------+----------|
       HSV_ACC1,  HSV_BASE_FULL(8), HSV_BASE_FULL(12), HSV_BASE_FULL(16),         {HSV_OFF}, HSV_BASE(24),  {HSV_OFF},   HSV_BASE(32), HSV_BASE(36),  HSV_ACC2, HSV_ACC2, HSV_BASE(48), HSV_BASE(52), {HSV_OFF},
  //|----------+------------------+------------------+------------------+------------------+-------------+-----------'  `------------+-------------+----------+---------+-------------+-------------+----------|
